...
import type { AuthResponse, Cart, CartItem, Category, Notification, Order, OrderItem, Product, User, Wishlist, WishlistItem } from '@/types';

export const authApi = {
  async register(payload: { email: string; username: string; password: string; password_confirm: string }) {
